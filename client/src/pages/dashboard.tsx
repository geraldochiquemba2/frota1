...
const mockVehicles = [
  { id: "v1", plate: "ABC-1234", make: "Ford", model: "Transit", year: 2022, status: "active" as const, driver: "John Smith", location: "Av. Paulista, 1000", fuelLevel: 75, odometer: 45230, lat: -23.5505, lng: -46.6333 },
...
const mockAlerts = [
  { id: "a1", type: "fuel" as const, title: "Low Fuel Warning", description: "Vehicle GHI-3456 fuel level below 15%", timestamp: "10 minutes ago" },
  { id: "a2", type: "document" as const, title: "License Expiring", description: "Driver Maria Santos license expires in 15 days", timestamp: "1 hour ago" },
  { id: "a3", type: "maintenance" as const, title: "Maintenance Overdue", description: "Vehicle ABC-1234 is overdue for oil change", timestamp: "2 hours ago" },
];
    ...
    <div className="space-y-6 p-6">
      <div className="flex items-center justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="text-muted-foreground">Fleet overview and quick insights</p>
        </div>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between gap-2">
              ...
              <Button variant="ghost" size="sm" asChild>
                <Link href="/map">
                  View Full Map <ArrowRight className="h-4 w-4 ml-1" />
                </Link>
              </Button>
            </CardHeader>
            <CardContent>
      ...
      <div>
        <div className="flex items-center justify-between gap-2 mb-4">
          ...
          <Button variant="ghost" size="sm" asChild>
            <Link href="/vehicles">View All <ArrowRight className="h-4 w-4 ml-1" /></Link>
          </Button>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
